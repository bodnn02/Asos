                        ...
                        <div class="account-block__content">
                            <main class="container">
                                <div class="content-title">
                                    ...
                                    <h1 class="content-title__h1">Change password</h1>
                                    <p class="content-title__p">Feel free to update your password so your ASOS account stays secure.</p>
                                </div>
                                        ...
                                        <div class="container">
                                            <div class="form-top">
                                                <div class="account-input">
                                                    <label for="">
                                                        <span class="account-input__title">Current Password:</span>
                                                ...
                                                <div class="account-input">
                                                    <label for="">
                                                        <span class="account-input__title">New Password:</span>
                                                        <span class="account-input__input">
                                                            <span class="container">
                                                                <input maxlength="120" tags="[object Object]" name="password" aria-invalid="false" aria-required="true" aria-describedby="label-password error-password minimumlength" class="_2yQHTjMvRnzbhJs1_yt0QU _3Fu5Rzk5BdJtSDPmMCb-QG" type="password" value="">
                                                            </span>
